...
$cats             = wp_get_post_terms( $form_id, 'give_forms_category', array("fields" => "all") );
?>

<div class="give-grid__item <?php echo 'give-cat-' . $cats[0]->slug; ?>">
	<?php
	...
	?>
		...
		<div class="give-card__body">
			...
			// Maybe display the form categories
			if ( !empty($cats) ) {
				echo '<p class="give-form-category">' . $cats[0]->name . '</p>';
			}
