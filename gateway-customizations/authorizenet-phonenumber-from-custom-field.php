 ...
 *
 * Note that this is meant for version of The Give Authorize gateway plugin BEFORE 1.3.3, when the gateway code was changed from POST transactions to webhooks. This codes does not work with webhooks.
 * 
